...
const JobCard = ({ job }) => {
    const { title, location, jobType, category, applicationDeadline, description, salaryRange, company, requirements, company_logo } = job
    return (
            ...
            <div className="card-body">
                ...
                <div className="justify-end card-actions">
                    <Link  className="relative inline-block px-4 py-2 font-medium group">
                        ...
                        <span className="relative text-black group-hover:text-white">Apply Now</span>
                    </Link>
                </div>
            </div>
        </div>
